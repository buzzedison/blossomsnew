            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-8 pink-dashed">
                        <h5 class="baloobhai text-center pt-4 pb-0 fw-bolder">Monday to Friday Free Sessions </h5>
                        <div class="pb-2 text-center">
                            <strong>Monday to Friday Free Sessions (All Year - Stretched Funding Allowance) Subject to availability.</strong>
                            <p class="text-muted" style={{fontSize: "158px"}}>Standalone sessions only. Children must bring a bag of consumables with them. Please ask for details.</p>
                        </div>
