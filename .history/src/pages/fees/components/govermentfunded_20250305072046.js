    ...
    return (
        <div id="FundedSessions" class="py-5 pt-5 mt-5">
            ...
            <div class="container">
               ...
               <p class="baloobhai text-center">Monday to Friday Funded Sessions (All Year, All-inclusive) Subject to availability.
Funding can only be used during these set session times. All consumables are included in these sessions.
</p>
                    </div>
