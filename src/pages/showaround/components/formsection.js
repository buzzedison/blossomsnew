...
const Formsection = () => {
    ...
    const [showarounddate,setShowaroundDate] = React.useState('');
    ...
    const submit = async (e) => {
        ...
        if(recapResp.length > 0){
            let data = {
                fname,age,familyname,childfamilyname,startdate,showarounddate,email,phone,zip, captcha: recapResp, form: "showaround"
            };
            ...
            axios.post("https://www.blossomschildcarenursery.co.uk/mailer/invoke.php", qs.stringify(data)).then(() => {
                setRecapresp("");
                navigate("/BookAShow-Around-ENQUIRY-COMPLETE");
            }).catch((e) => {
                    ...
                    <form action="#">
                        <div class="row">
                            <div class="col-lg-6 px-md-5">
                                ...
                                <div class="form-group">
                                    <label for="">Child’s Potential Start Date</label>
                            ...
                            <div class="col-lg-6 px-md-5">
                                ...
                                <div class="form-group">
                                    <label for="">Preferred Show-around Dates</label>
                                    <input type="text" name="" id="" class="form-control" onChange={e => setShowaroundDate(e.target.value)} />
                                </div>
                        ...
                        <div class="form-group d-flex justify-content-center mt-5">
                            <a href="#" class="btn btn-sm pink-btn baloobhai regular text-white fs-7" onClick={submit}>Submit</a>
                        </div>
                    </form>
                </div>
            </div>
